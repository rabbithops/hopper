...
* Confirmed fix for rule-empty-line-before from Hopper 7.7.3
...
* Move trailing slash to themeDir variable #6 ([related Hopper PR](https://github.com/digitoimistodude/hopper/pull/75))

### 2.0.3: 2021-02-25

* Fix js task signal async completion ([hopper 6.8.6](https://github.com/digitoimistodude/hopper/releases/tag/6.8.6))
### 2.0.2: 2021-02-25

* Fix CSS path for [hopper](https://github.com/digitoimistodude/hopper/) 6.8.4
* Fix default browsersync certificate
### 2.0.1: 2021-02-19

* Get new dev/prod build process from hopper #5
