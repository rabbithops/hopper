...
* Deprecate core/code, core/columns, core/cover, core/embed, core/preformatted and code/verse CSS from Hopper, use Gutenberg official styles instead
...
* Add data-version attribute to footer indicating Hopper version in use
...
* Bypass the file_get_contents restriction [#112](https://github.com/digitoimistodude/hopper/pull/112)
...
See [pull request #89](https://github.com/digitoimistodude/hopper/pull/89).
...
- Add extra notifications that these scripts need Hopper and dev servers to work
...
* Build production and development JS builds in gulp watch, [#63](https://github.com/digitoimistodude/hopper/pull/63)
* Make us of new wp_get_environment_type function in modular content, [#65](https://github.com/digitoimistodude/hopper/pull/65)

### 6.7.1: 2021-02-18

* Accessibility: Add required outline parameters for global links, [ab54efc](https://github.com/digitoimistodude/hopper/commit/ab54efc820bfd94a6a15ea492e143971c54ea684)
* Add button components, [#62](https://github.com/digitoimistodude/hopper/pull/62)
...
* Update documentation about installing Hopper on any development environment
